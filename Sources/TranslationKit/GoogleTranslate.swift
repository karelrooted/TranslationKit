...
public class GoogleTranslate: TranslateBackend {
    /// Shared instance.
    ...
    public func translate(_ q: String, _ target: String, _ source: String = "") async throws -> String {
        return try await translate(q, target, source, "text", "base")
    }
     ...
     */
    public func translate(_ q: String, _ target: String, _ source: String, _ format: String = "text", _ model: String = "base") async throws -> String {
